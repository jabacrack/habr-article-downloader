...
Это форк (копия с дополнениями) Habr Article Downloader с поддержкой отправки статей в **Joplin Desktop**. Можно сохранить статью прямо с Habr в выбранный блокнот Joplin через локальную службу Web Clipper. Инструкция по подключению — в разделе [«Сохранить в Joplin»](#сохранить-в-joplin).
